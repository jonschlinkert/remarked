...
function Parser(options) {
  ...
  this._options.renderer = this._options.renderer || new Renderer;
...
Parser.prototype.tok = function () {
  ...
  switch (this.token.type) {
    ...
    case 'loose_item_start':
      ...
      return this.renderer.listitem(body);
    case 'html':
      var html = !this.token.pre && !this._options.pedantic ? this.inline.output(this.token.text) : this.token.text;
